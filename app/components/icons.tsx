...
// Icon 1: Tổng quan (Dashboard Grid Icon)
...
// Icon 2: Sinh viên (Student Graduation Cap Icon)
export function StudentIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 3: Giảng viên (Teacher / Instructor Badge Icon)
...
// Icon 4: Khóa học (Course Book Icon)
export function CourseIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 5: Người dùng / Tài khoản (User Shield Icon)
...
// Icon 6: Thông báo (Notification Bell Icon)
...
// Icon 10: Mũi tên chuyển trang (Arrow Right Icon)
...
// Icon 11: Cảnh báo (Alert Triangle Icon)
...
// Icon 12: Quản lý Lớp (Class Group Users Icon)
export function ClassGroupIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 13: Lịch học (Calendar Schedule Icon)
export function ScheduleIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 14: Ngành học (Major Academic Layers Icon)
export function MajorIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 15: Phòng học (Classroom Building Icon)
export function RoomIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 18: Điểm số / Quản lý điểm (Award / Grade Icon)
export function GradeIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 19: Bảng điểm / Kết quả học tập (Transcript / Report Icon)
export function TranscriptIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 20: Sách mở (Book Open Icon)
...
// Icon 23: Tải xuống (Download Icon)
...
// Icon 24: Mũ cử nhân (Graduation Cap Icon)
...
// Icon 26: Thời gian (Time Clock Icon)
...
// Icon 28: Xác nhận người dùng (User Check Icon)
...
// Icon 29: Thẻ thanh toán / Tài chính (Credit Card Icon)
...
// Icon 30: Tiền tệ / Học phí (Banknotes Icon)
...
// Icon 31: Khiên bảo mật / Quyền / Vai trò (Shield Check / Role Icon)
...
// Icon 32: Bánh răng / Quản trị hệ thống (Cog / Settings Icon)
...
// Icon 33: Điểm danh / Bảng kiểm tra (Clipboard Check Icon)
export function ClipboardCheckIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
// Icon 34: Cấm thi / Cảnh báo sinh viên (User X Icon)
export function UserXIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
      <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
      <circle cx="8.5" cy="7" r="4" />
...
// Icon 35: Xuất dữ liệu / Export (Export File Icon)
export function ExportIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
      <polyline points="7 10 12 15 17 10" />
...
// Icon 36: Lịch / Calendar (Calendar Icon)
...
// Icon 37: Tòa nhà / Đơn vị (Building Icon)
...
// Icon 38: Đồng hồ / Thời gian chờ (Clock Icon)
