...
export function EduManageLogo({ size = 36, className = "" }: IconProps) {
  return (
    ...
    >
      <div className="grid size-full place-items-center rounded-[10px] bg-slate-950/80 text-xs font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-blue-400 to-indigo-200">
        E
      </div>
    </div>
  );
