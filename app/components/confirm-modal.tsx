...
export function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 dark:bg-slate-950/75 p-4 backdrop-blur-xl animate-in fade-in duration-200">
      <div className="w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 dark:border-white/15 bg-white dark:bg-slate-900/95 p-6 shadow-2xl backdrop-blur-2xl text-slate-900 dark:text-slate-100">
        <div className="flex items-center gap-3.5">
          <div className="grid size-12 place-items-center rounded-2xl border border-red-500/30 bg-red-500/10 text-red-500 dark:text-red-400 shadow-[0_0_20px_rgba(239,68,68,0.25)]">
        ...
        <div className="mt-6 flex justify-end gap-3 border-t border-slate-200 dark:border-white/10 pt-4">
          ...
          <button
            ...
            className={`flex items-center gap-2 rounded-xl px-5 py-2.5 text-xs font-bold text-white shadow-lg hover:brightness-110 active:scale-95 disabled:opacity-50 transition-all cursor-pointer ${buttonStyle}`}
          >
